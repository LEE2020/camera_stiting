...
namespace pc{
   ...
   //"./resources/calibration_data//LAffineLX.txt"};
    static char *parm_files[6]={
            "./resources/calibration_data//FFAffineLX.txt",
            "./resources/calibration_data//FLAffineLX.txt",
            "./resources/calibration_data//BLAffineLX.txt",
            "./resources/calibration_data//BBAffineLX.txt",
            "./resources/calibration_data//BRAffineLX.txt",
            "./resources/calibration_data//FRAffineLX.txt"};
...
//    const int seamTypeFirstFrame = 3;
    ...
    const int original_threads_num = threads_num;
